...
import fr.danakube.danacobblegen.Chat.*;
...
public class GUIManager {
	...
	public class ConfirmGUI {
		...
		public ConfirmGUI(Player p, Tier tier){
			player = p;
			ItemStack cancelItem = new ItemStack(Objects.requireNonNull(XMaterial.RED_DYE.parseMaterial()));
	...
	public class AdminGUI {
		...
		public AdminGUI(Player p) {
			this.player = p;
			Material redstoneTorch = Material.REDSTONE_TORCH;
